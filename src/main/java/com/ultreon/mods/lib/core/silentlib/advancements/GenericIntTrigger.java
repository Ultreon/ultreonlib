...
package com.ultreon.mods.lib.core.silentlib.advancements;
...
public class GenericIntTrigger implements CriterionTrigger<GenericIntTrigger.Instance> {
    private static final ResourceLocation ID = new ResourceLocation(ModdingLibrary.MOD_ID, "generic_int");

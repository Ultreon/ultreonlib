...
public class InternalConfigScreen extends GenericMenuScreen {
    ...
    public InternalConfigScreen(Screen back) {
        ...
        addButtonRow(Component.translatable("gui.ultreon.gui_lib.config.theme").append(UltreonGuiLib.getTheme().getDisplayName()), this::changeTheme);
        addButtonRow(Component.translatable("gui.ultreon.gui_lib.config.title_style").append(UltreonGuiLib.getTitleStyle().getDisplayName()), this::changeTitleStyle);
    }
    ...
    private void changeTheme(Button button) {
        ...
        button.setMessage(Component.translatable("gui.ultreon.gui_lib.config.theme").append(theme.getDisplayName()));
    }
    ...
    private void changeTitleStyle(Button button) {
        ...
        button.setMessage(Component.translatable("gui.ultreon.gui_lib.config.title_style").append(UltreonGuiLib.getTitleStyle().getDisplayName()));
    }

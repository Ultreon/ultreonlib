package com.ultreon.modlib.client.render;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import com.ultreon.modlib.api.annotations.FieldsAreNonnullByDefault;
import com.ultreon.modlib.common.geom.RectangleUV;
...
public class Renderer {
    ...
    public Renderer(PoseStack poseStack, Font font) {
        this(poseStack, font, null);
    }

    public Renderer(PoseStack poseStack, Font font, @Nullable Screen screen) {

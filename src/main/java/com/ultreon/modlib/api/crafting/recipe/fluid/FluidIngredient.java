...
public class FluidIngredient implements Predicate<FluidStack> {
    ...
    public FluidIngredient(@Nonnull Tag.Named<Fluid> tag) {
        this(tag, 1000);
    }

    public FluidIngredient(@Nonnull Tag.Named<Fluid> tag, int amount) {
        this.tag = tag;
        this.fluid = null;
        this.amount = amount;
    }
    ...
    private List<FluidStack> getFluidsFromTagHack() {
        ...
        try {
            ...
            UltreonModLib.LOGGER.warn("Fluid tags not bound when needed! Trying to fetch tags...");

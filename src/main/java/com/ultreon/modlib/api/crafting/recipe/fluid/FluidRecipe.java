...
public interface FluidRecipe<C extends FluidInventory> extends Recipe<C> {
    ...
    static FluidStack readFluid(FriendlyByteBuf buffer) {
        ...
        if (fluid != null) {
            ...
            UltreonModLib.LOGGER.error("Unknown fluid: {}", fluidId);
    ...
    /**
     * Get the fluids which result from this recipe. Similar to {@link #getFluidResults(FluidInventory)}.
     *
    ...
    /**
     * Get the fluids which result from this recipe, ignoring the inventory. Similar to {@link #getFluidOutputs()}, needed for JEI support.
     *
     * @return A list of fluids produced
     */

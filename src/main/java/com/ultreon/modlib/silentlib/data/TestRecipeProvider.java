...
public class TestRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        UltreonModLib.LOGGER.warn("Running test recipe provider! These files should NOT be included in release!");
        ...
        DamageItemRecipeBuilder.builder(Items.DIAMOND, 9)
                ...
                .build(consumer, UltreonModLib.getId("damage_item_test1"));
        DamageItemRecipeBuilder.builder(Items.EMERALD, 9)
                ...
                .build(consumer, UltreonModLib.getId("damage_item_test2"));
        ExtendedShapelessRecipeBuilder.vanillaBuilder(Blocks.DIRT, 10)
                ...
                .build(consumer, UltreonModLib.getId("extended_shapeless_test1"));
        ...
        ExtendedShapedRecipeBuilder.vanillaBuilder(Items.DIAMOND_SWORD)
                ...
                .build(consumer, UltreonModLib.getId("extended_shaped_test1"));
    }

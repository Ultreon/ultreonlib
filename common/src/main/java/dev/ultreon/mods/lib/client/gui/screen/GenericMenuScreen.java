...
public abstract class GenericMenuScreen extends BaseScreen implements Stylized {
    ...
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, BaseButton.CommandCallback onPressL, BaseButton.TooltipFactory onTooltipL, Component componentR, BaseButton.CommandCallback onPressR, BaseButton.TooltipFactory onTooltipR) {
        return addButtonRow(componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), onPressL, onTooltipL, componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), onPressR, onTooltipR);
    }
    ...
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, Runnable onPressL, BaseButton.TooltipFactory onTooltipL, Component componentR, Runnable onPressR, BaseButton.TooltipFactory onTooltipR) {
        return addButtonRow(componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), createCallbackWrapper(onPressL), onTooltipL, componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), createCallbackWrapper(onPressR), onTooltipR);
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR) {
        return addButtonRow(componentL, typeL, GenericMenuScreen::emptyAction, componentR, typeR, GenericMenuScreen::emptyAction);
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, BaseButton.CommandCallback onPressL, Component componentR, BaseButton.CommandCallback onPressR) {
        return addButtonRow(componentL, typeL, onPressL, componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), onPressR);
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, Runnable onPressL, Component componentR, Runnable onPressR) {
        return addButtonRow(componentL, typeL, createCallbackWrapper(onPressL), componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), createCallbackWrapper(onPressR));
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, BaseButton.CommandCallback onPressL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, BaseButton.CommandCallback onPressR) {
        return addButtonRow(componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), onPressL, componentR, typeR, onPressR);
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, Runnable onPressL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, Runnable onPressR) {
        return addButtonRow(componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), createCallbackWrapper(onPressL), componentR, typeR, createCallbackWrapper(onPressR));
    }

    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, BaseButton.CommandCallback onPressL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, BaseButton.CommandCallback onPressR) {
    ...
    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, Runnable onPressL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, Runnable onPressR) {
    ...
    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, Runnable onPressL, BaseButton.TooltipFactory onTooltipL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, Runnable onPressR, BaseButton.TooltipFactory onTooltipR) {
    ...
    @SuppressWarnings("unused")
    public Pair<BaseButton, BaseButton> addButtonRow(Component componentL, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeL, BaseButton.CommandCallback onPressL, BaseButton.TooltipFactory onTooltipL, Component componentR, dev.ultreon.mods.lib.client.gui.widget.Button.Type typeR, BaseButton.CommandCallback onPressR, BaseButton.TooltipFactory onTooltipR) {
        if (this.frozen) {
            return null;
        }

        BaseButton left = new dev.ultreon.mods.lib.client.gui.widget.Button(0, 0, 0, 0, componentL, onPressL, onTooltipL, typeL);
        BaseButton right = new dev.ultreon.mods.lib.client.gui.widget.Button(0, 0, 0, 0, componentR, onPressR, onTooltipR, typeR);
    ...
    public BaseButton addButtonRow(Component component, Runnable onPress, BaseButton.TooltipFactory onTooltip) {
        return addButtonRow(component, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), btn -> onPress.run(), onTooltip);
    }
    ...
    public BaseButton addButtonRow(Component component, BaseButton.CommandCallback onPress, BaseButton.TooltipFactory onTooltip) {
        return addButtonRow(component, dev.ultreon.mods.lib.client.gui.widget.Button.Type.of(globalTheme.getContentTheme()), onPress, onTooltip);
    }

    @SuppressWarnings("unused")
    public BaseButton addButtonRow(Component component, dev.ultreon.mods.lib.client.gui.widget.Button.Type type) {
        return addButtonRow(component, type, GenericMenuScreen::emptyAction);
    }

    @SuppressWarnings("unused")
    public BaseButton addButtonRow(Component component, dev.ultreon.mods.lib.client.gui.widget.Button.Type type, BaseButton.CommandCallback onPress) {
        return addButtonRow(component, type, onPress, GenericMenuScreen::nullTooltip);
    }

    @SuppressWarnings("unused")
    public BaseButton addButtonRow(Component component, dev.ultreon.mods.lib.client.gui.widget.Button.Type type, Runnable onPress) {
        return addButtonRow(component, type, btn -> onPress.run(), GenericMenuScreen::nullTooltip);
    }

    @SuppressWarnings("unused")
    public BaseButton addButtonRow(Component component, dev.ultreon.mods.lib.client.gui.widget.Button.Type type, Runnable onPress, BaseButton.TooltipFactory onTooltip) {
        return addButtonRow(component, type, btn -> onPress.run(), onTooltip);
    }

    @SuppressWarnings("unused")
    public BaseButton addButtonRow(Component component, dev.ultreon.mods.lib.client.gui.widget.Button.Type type, BaseButton.CommandCallback onPress, BaseButton.TooltipFactory onTooltip) {
        if (this.frozen) {
            return null;
        }

        BaseButton button = new dev.ultreon.mods.lib.client.gui.widget.Button(0, 0, 0, 0, component, onPress, onTooltip, type);

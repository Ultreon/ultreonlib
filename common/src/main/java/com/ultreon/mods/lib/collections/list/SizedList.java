...
import com.ultreon.mods.lib.functions.misc.Applier;
import com.ultreon.mods.lib.collections.exceptions.OutOfRangeException;
import com.ultreon.mods.lib.collections.exceptions.ValueExistsException;
import com.ultreon.mods.lib.collections.Arrays;
import com.ultreon.mods.lib.collections.Range;
...
public class SizedList<T> {
    ...
    public Range[] getRanges() {
        ...
        for (Double size : this.sizes) {
            ...
            ranges = Arrays.add(ranges, new Range(currentSize, newSize));
            currentSize = newSize;
        }

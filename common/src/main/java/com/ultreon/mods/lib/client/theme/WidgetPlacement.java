...
public enum WidgetPlacement implements ThemeComponent {
    ...
    WidgetPlacement(Function<GlobalTheme, Style> themeMapper) {
    ...
    public Theme get() {
        return this.get(GlobalTheme.get());
    }

    public Theme get(GlobalTheme theme) {
